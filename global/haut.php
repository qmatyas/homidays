<?php include 'global/trads/haut_' . LANG . '.php'; ?>
<!DOCTYPE html>
...
<body>
    <h1 class="homidays">Homidays</h1>
		...
		<li><a href="<?= url(); ?>"><?= TXT_accueil; ?></a></li>
		<li><a href="<?= url('logements', 'lister'); ?>"><?= TXT_logements; ?></a></li>
		<li><a href="<?= url('membres', 'lister'); ?>"><?= TXT_membres; ?></a></li>
<?php if (LANG === 'en') : ?>
