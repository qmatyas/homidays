	...
	<fieldset>
		...
		<legend><b>Quartier</b></legend>
			...
			<p>
				...
				<input type="checkbox" name="autre" id="autre" <?= isset($_POST['autre']) && $_POST['autre'] === 'on' ? ' checked' : ''; ?>><label for="autre">Autre</label>
		...
		<legend><b>Informations complémentaires</b></legend>
			...
			<p>
				...
				<input type="checkbox" name="discuter_voisine" id="discuter_voisine" <?= isset($_POST['discuter_voisine']) && $_POST['discuter_voisine'] === 'on' ? ' checked' : ''; ?>><label for="discuter_voisine">Discuter avec la vieille voisine</label></br>
